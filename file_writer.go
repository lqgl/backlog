...
type FileWriter struct {
	...
	*bufio.Writer
	file          *os.File
	level         Level  // The log level written to this file
...
// NewFileWriter fileWriter constructor
...
func createLogFile(levelName, logDir string, t time.Time) (f *os.File, fileName string, err error) {
	...
	if err == nil { // create log file success
...
func getLogName(levelName string, t time.Time) (name, link string) {
	name = fmt.Sprintf("%s.log.%04d%02d%02d.%4d",
		program,
		t.Year(),
		t.Month(),
		t.Day(),
